...
public class ChildProfileSettings extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.remove("childNamePref");
        editor.remove("childGenderPref");
        editor.apply();
...
//        Log.v("name", userLocalStore.getChildForThisPhone());
        ...
        childNamePref.setSummary(userLocalStore.getChildForThisPhone());
//
